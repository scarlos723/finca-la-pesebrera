  ...
  return (
    <section className="container my-20">
      <div className="grid lg:grid-cols-2 rounded-2xl shadow-2xl overflow-hidden">
        <BlurFade direction="left" amount={28} duration={0.8}>
          <div className="bg-[#2D4F1E] p-14 lg:p-26 h-full">
            ...
            <p className="mt-10 lg:max-w-2xl text-lgsm text-[#A9D293] text-pretty">
              ...
              perfecto nos rodea los 365 días del año. La Pesebrera es el punto
              de encuentro donde la tradición se funde con el descanso
            </p>
            <a
        ...
        <motion.div
          className="flex items-center bg-[#EEECE0]"
          initial={reduce ? false : { opacity: 0, x: 28, scale: 0.96, filter: "blur(6px)" }}
          whileInView={
            reduce ? undefined : { opacity: 1, x: 0, scale: 1, filter: "blur(0px)" }
          }
